...
st.markdown(
    ...
    /* Make main content slightly transparent */
    .stApp .main {
...
SERPAPI_KEY = "621e4591b771d92ae6759f600b855c4b309711da9edf17bf9339448f137799fe"
GOOGLE_API_KEY = "AIzaSyBxHT-6P7DWWV41MPRL7XvIB3JVeKHQGG4"
...
planner = Agent(
    name="Planner",
    role=f"Plans tasks. Current date: {datetime.now()}",
    model=gemini_model
)

hotel_restaurant_finder = Agent(
    name="Hotel & Restaurant Finder",
    role=f"Finds hotels & restaurants. Current date: {datetime.now()}",
    model=gemini_model
)
